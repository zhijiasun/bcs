...
#    url(r'^example/index$','example.views.index'),
 #   url(r'^example/hello$','example.views.hello'),
  #  url(r'^example/add_comment$','example.views.ajax_addComment'),
   # url(r'^about/$',AboutView.as_view()),
    #url(r'^publishers/$', PublisherList.as_view()),
 #   url(r'^test/$','example.views.ajax_in_django'),
  #  url(r'^contact_form/$','example.views.contact_form'),
   # url(r'^test/(?P<fact_id>\d+)/$','example.views.quiz_guess'),
)
